Date:20210218 gli300nv2 终于编译成功了，只保留了ssr+xray1.3核心的插件，固件其实还有问题当改变自身地址时，再一次就打不开路由的新地址了，但是ssh以及路由自身功能不任何受影响，所以编译以前最好确定好你自己的路由器ip地址和要自定义的名称，否则更改起来不知道会有什么问题。目前运行起来效果良好。
